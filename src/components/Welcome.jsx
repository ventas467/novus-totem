...
export default function Welcome({ onStart, onOpenAdmin }) {
  ...
  return (
    <div className="relative flex flex-col items-center justify-between h-full w-full p-4 md:p-8 bg-gradient-to-b from-novus-dark via-novus to-novus-dark overflow-hidden scanlines">
      ...
      {/* HEADER & LOGO CORPORATIVO ORIGINAL NOVUS (SOBRE LA CAPA SCANLINES Z-100) */}
      <div className="flex flex-col items-center space-y-3 mt-2 text-center z-[100] relative w-full max-w-2xl">
      ...
      <div className="relative flex flex-col items-center justify-center my-2 z-10">
        ...
        <div className="absolute -top-10 text-white/30 text-2xl select-none pointer-events-none">
          ☁️ &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; ☁️
        </div>
      ...
      <div className="w-full max-w-md flex flex-col items-center z-10 mb-2">
        <button
          onClick={handleStart}
          className="w-full py-5 md:py-6 bg-yellow-400 hover:bg-yellow-300 text-black font-black text-lg md:text-xl tracking-widest pixel-button border-4 border-black text-center shadow-pixel-lg uppercase flex items-center justify-center gap-3 active:scale-95 transition-transform animate-pulse"
        >
